function  prealignSinglespikes(mycellids,varargin)
%PREALIGNSINGLESPIKES   Align single spikes to events and calculates rates for each epoch.
%   PREALIGNSPIKES(MYCELLIDS) alignes single (non-burst) spikes of cells corresponding to 
...
%
%   See also PREALIGNSPIKES, VIEWCELL2B and PLOT_RASTER2A.

%   Edit log: AK 11/06; 2/11, BH 6/27/11, 5/10/12, 2/11/20
...
for i = 1:length(mycellids)
    ...
    [event_stimes,event_windows] = extractEventBursts(cellid,events,'single',EV);
