function  prealignBursts(mycellids,varargin)
%PREALIGNBURSTS   Align bursts to events and calculates rates for each epoch.
%   PREALIGNBURSTS(MYCELLIDS) alignes spikes of cells corresponding to 
...
for i = 1:length(mycellids)
    ...
    [event_stimes,event_windows] = extractEventBursts(cellid,events,'burst',EV);
