function acg30(cellids,window,varargin)
%ACG30   Auto-correlation.
%   ACG30(CELLIDS,WINDOW) calculates auto-correlations at 0.5 ms resolution 
...
%   0-30 ms and mean ACG for lags 180-200 ms. The normalizing factor is the
...
%         sccr2 = filtfilt(flt,1,sccr);   % high-pass filter > 1 Hz
        ...
        bar(lags(lags>-30&lags<30),ccr(lags>-30&lags<30),'FaceColor','g','EdgeColor','g')
