function viewcell2p(cellid,varargin)
%VIEWCELL2P   Raster plot and PSTH.
%   VIEWCELL2P(CELLID,'TRIGGERNAME',TRIGEVENT,'SORTEVENT',SEVENT,'EVENTTYPE
%   ',EVTYPE) plots a light triggered or event triggered raster and PSTH
%   of single spikes for a given cell. TRIGEVENT is used as trigger and trials are sorted
