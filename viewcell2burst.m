function viewcell2burst(cellid,varargin)
%VIEWCELL2B   Raster plot and PSTH.
%   VIEWCELL2BURST(CELLID,'TRIGGERNAME',TRIGEVENT,'SORTEVENT',SEVENT,'EVENTTYPE
%   ',EVTYPE) plots a light triggered or event triggered raster and PSTH
%    of burst spikes for a given cell. TRIGEVENT is used as trigger and trials are sorted
...
%
%   See also PREALIGNBURSTS, STIMES2BINRASTER, BINRASTER2PSTH,
%   PLOT_RASTER2A.
